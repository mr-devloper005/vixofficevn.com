export const siteIdentity = {
  code: process.env.NEXT_PUBLIC_SITE_CODE || 'vixofficevn',
  name: process.env.NEXT_PUBLIC_SITE_NAME || 'Vixofficevn',
  ...
  domain: process.env.NEXT_PUBLIC_SITE_DOMAIN || 'vixofficevn.com',
  url: process.env.NEXT_PUBLIC_SITE_URL || 'https://vixofficevn.com',
